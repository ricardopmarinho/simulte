//
// Generated file, do not edit! Created by nedtool 5.0 from common/timer/TTimerMsg.msg.
//
...
TTimerMsg::TTimerMsg(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
    this->timerId = 0;
    this->type = 0;
}
