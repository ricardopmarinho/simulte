...
CAINInfo::CAINInfo(const CAINInfo& other) : ::omnetpp::cPacket(other)
{
    copy(other);
}
...
CAINInfo& CAINInfo::operator=(const CAINInfo& other)
{
...
void CAINInfo::setDirection(unsigned short direction)
{
    this->direction = direction;
}

unsigned short CAINInfo::getFrameType() const
{
    return this->frameType;
}

void CAINInfo::setFrameType(unsigned short frameType)
{
    this->frameType = frameType;
}

class CAINInfoDescriptor : public omnetpp::cClassDescriptor
{
  private:
    mutable const char **propertynames;
  public:
    CAINInfoDescriptor();
    virtual ~CAINInfoDescriptor();
...
Register_ClassDescriptor(CAINInfoDescriptor);

CAINInfoDescriptor::CAINInfoDescriptor() : omnetpp::cClassDescriptor("CAINInfo", "omnetpp::cPacket")
{
    propertynames = nullptr;
}

CAINInfoDescriptor::~CAINInfoDescriptor()
{
    delete[] propertynames;
}

bool CAINInfoDescriptor::doesSupport(omnetpp::cObject *obj) const
{
    return dynamic_cast<CAINInfo *>(obj)!=nullptr;
}

const char **CAINInfoDescriptor::getPropertyNames() const
{
    if (!propertynames) {
...
const char *CAINInfoDescriptor::getProperty(const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
...
const char *CAINInfoDescriptor::getFieldTypeString(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *CAINInfoDescriptor::getFieldProperty(int field, const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int CAINInfoDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string CAINInfoDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool CAINInfoDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *CAINInfoDescriptor::getFieldStructName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *CAINInfoDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
