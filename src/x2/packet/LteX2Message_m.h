 ...
 *     virtual LteX2Message *dup() const {return new LteX2Message(*this);}
...
class LteX2Message_Base : public ::omnetpp::cPacket
{
  ...
  protected:
    ...
    LteX2Message_Base(const char *name=nullptr, int kind=0);
  ...
  public:
    ...
    virtual LteX2Message_Base *dup() const {throw omnetpp::cRuntimeError("You forgot to manually add a dup() function to class LteX2Message");}
 ...
 *     virtual X2InformationElement *dup() const {return new X2InformationElement(*this);}
...
class X2InformationElement_Base : public ::omnetpp::cPacket
{
  ...
  protected:
    ...
    // make constructors protected to avoid instantiation
    X2InformationElement_Base(const char *name=nullptr, int kind=0);
  ...
  public:
    ...
    virtual X2InformationElement_Base *dup() const {throw omnetpp::cRuntimeError("You forgot to manually add a dup() function to class X2InformationElement");}
    virtual void parsimPack(omnetpp::cCommBuffer *b) const;
    virtual void parsimUnpack(omnetpp::cCommBuffer *b);
