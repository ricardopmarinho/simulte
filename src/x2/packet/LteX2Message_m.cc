//
// Generated file, do not edit! Created by nedtool 5.0 from x2/packet/LteX2Message.msg.
//
...
LteX2Message_Base::LteX2Message_Base(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
    this->sourceId = 0;
...
X2InformationElement_Base::X2InformationElement_Base(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
}
