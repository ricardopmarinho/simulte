//
// Generated file, do not edit! Created by nedtool 5.0 from apps/voip/VoipPacket.msg.
//
...
VoipPacket::VoipPacket(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
    this->IDtalk = 0;
    this->nframes = 0;
    this->IDframe = 0;
