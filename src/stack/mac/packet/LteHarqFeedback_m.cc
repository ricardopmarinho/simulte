//
// Generated file, do not edit! Created by nedtool 5.0 from stack/mac/packet/LteHarqFeedback.msg.
//
...
LteHarqFeedback::LteHarqFeedback(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
    this->acid = 0;
    this->cw = 0;
    this->result = false;
