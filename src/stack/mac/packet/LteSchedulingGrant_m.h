 ...
 *   public:
 *     LteSchedulingGrant(const char *name=nullptr, int kind=0) : LteSchedulingGrant_Base(name,kind) {}
...
class LteSchedulingGrant_Base : public ::omnetpp::cPacket
{
  ...
  protected:
    ...
    LteSchedulingGrant_Base(const char *name=nullptr, int kind=0);
  ...
  public:
    ...
    virtual LteSchedulingGrant_Base *dup() const {throw omnetpp::cRuntimeError("You forgot to manually add a dup() function to class LteSchedulingGrant");}
