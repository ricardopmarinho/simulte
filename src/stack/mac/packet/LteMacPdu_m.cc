//
// Generated file, do not edit! Created by nedtool 5.0 from stack/mac/packet/LteMacPdu.msg.
//
...
LteMacPdu_Base::LteMacPdu_Base(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
    this->headerLength = 0;
    this->macPduId = 0;
}
