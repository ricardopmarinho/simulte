//
// Generated file, do not edit! Created by nedtool 5.0 from stack/mac/packet/LteSchedulingGrant.msg.
//
...
LteSchedulingGrant_Base::LteSchedulingGrant_Base(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
    this->periodic = false;
    this->period = 0;
    this->expiration = 0;
