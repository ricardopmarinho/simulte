 ...
 *   public:
 *     LteMacPdu(const char *name=nullptr, int kind=0) : LteMacPdu_Base(name,kind) {}
...
class LteMacPdu_Base : public ::omnetpp::cPacket
{
  ...
  protected:
    ...
    LteMacPdu_Base(const char *name=nullptr, int kind=0);
  ...
  public:
    ...
    virtual LteMacPdu_Base *dup() const {throw omnetpp::cRuntimeError("You forgot to manually add a dup() function to class LteMacPdu");}
