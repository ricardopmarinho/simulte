 ...
 *   public:
 *     LteRlcAmPdu(const char *name=nullptr, int kind=0) : LteRlcAmPdu_Base(name,kind) {}
 ...
 *     virtual LteRlcAmPdu *dup() const {return new LteRlcAmPdu(*this);}
...
class LteRlcAmPdu_Base : public ::LteRlcPdu
{
  ...
  protected:
    ...
    LteRlcAmPdu_Base(const char *name=nullptr, int kind=0);
  ...
  public:
    ...
    virtual LteRlcAmPdu_Base *dup() const {throw omnetpp::cRuntimeError("You forgot to manually add a dup() function to class LteRlcAmPdu");}
