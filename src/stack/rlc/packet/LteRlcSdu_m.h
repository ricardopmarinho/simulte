...
class LteRlcSdu_Base : public ::omnetpp::cPacket
{
  ...
  protected:
    ...
    LteRlcSdu_Base(const char *name=nullptr, int kind=0);
  ...
  public:
    ...
    virtual LteRlcSdu_Base *dup() const {throw omnetpp::cRuntimeError("You forgot to manually add a dup() function to class LteRlcSdu");}
