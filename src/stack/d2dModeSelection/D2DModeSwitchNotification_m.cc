//
// Generated file, do not edit! Created by nedtool 5.0 from stack/d2dModeSelection/D2DModeSwitchNotification.msg.
//
...
D2DModeSwitchNotification::D2DModeSwitchNotification(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
    this->peerId = 0;
    this->txSide = false;
