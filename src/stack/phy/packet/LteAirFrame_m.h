 ...
 *   public:
 *     LteAirFrame(const char *name=nullptr, int kind=0) : LteAirFrame_Base(name,kind) {}
...
class LteAirFrame_Base : public ::AirFrame
{
  ...
  protected:
    ...
    LteAirFrame_Base(const char *name=nullptr, int kind=0);
  ...
  public:
    ...
    virtual LteAirFrame_Base *dup() const {throw omnetpp::cRuntimeError("You forgot to manually add a dup() function to class LteAirFrame");}
