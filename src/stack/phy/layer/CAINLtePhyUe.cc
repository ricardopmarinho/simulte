...
Define_Module(CAINLtePhyUe);

CAINLtePhyUe::CAINLtePhyUe()
{
...
void CAINLtePhyUe::initialize(int stage)
{
...
void CAINLtePhyUe::handleSelfMessage(cMessage *msg)
{
...
void CAINLtePhyUe::handoverHandler(LteAirFrame* frame, UserControlInfo* lteInfo)
{
...
void CAINLtePhyUe::triggerHandover()
{
    ...
    EV << NOW << " CAINLtePhyUe::triggerHandover - UE " << nodeId_ << " is starting handover to eNB " << candidateMasterId_ << "... " << endl;
...
void CAINLtePhyUe::doHandover()
{
    ...
    EV << NOW << " CAINLtePhyUe::doHandover - UE " << nodeId_ << " has completed handover to eNB " << masterId_ << "... " << endl;
...
void CAINLtePhyUe::handleAirFrame(cMessage* msg)
{
...
void CAINLtePhyUe::handleUpperMessage(cMessage* msg)
{
//    if (useBattery_) {
...
//void CAINLtePhyUe::handleHostState(const HostState& state)  {
//    /*
...
double CAINLtePhyUe::updateHysteresisTh(double v)
{
...
void CAINLtePhyUe::deleteOldBuffers(MacNodeId masterId)
{
...
DasFilter* CAINLtePhyUe::getDasFilter()
{
    return das_;
}

void CAINLtePhyUe::sendFeedback(LteFeedbackDoubleVector fbDl, LteFeedbackDoubleVector fbUl, FeedbackRequest req)
{
    Enter_Method("SendFeedback");
    EV << "CAINLtePhyUe: feedback from Feedback Generator" << endl;
